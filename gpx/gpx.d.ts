...
export declare class TrackSegment extends GPXTreeLeaf {
    ...
    clone(): TrackSegment;
    replaceTrackPoints(start: number, end: number, points: TrackPoint[], speed?: number, startTime?: Date, removeGaps?: boolean): void;
    _reverse(originalNextTimestamp?: Date, newPreviousTimestamp?: Date): void;
    roundTrip(): void;
...
export declare class TrackPoint {
    ...
    getCadence(): number;
    getPower(): number;
    setExtensions(extensions: Record<string, string>): void;
...
export declare function getElevationDistanceFunction(statistics: GPXStatistics): (point1: TrackPoint, point2: TrackPoint, point3: TrackPoint) => number;
